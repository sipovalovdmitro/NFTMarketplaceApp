...
ActiveRecord::Schema.define(version: 2023_05_04_064102) do
  ...
  create_table "collections", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.boolean "opensea_collection", default: false
  ...
  create_table "erc20_tokens", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.boolean "is_own_token", default: false
  end
  ...
  create_table "nft_contracts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.decimal "floor_price", precision: 32, scale: 16, default: "0.0"
    t.float "referral_percentage"
    t.string "contract_deployer"
    t.boolean "opensea_nft_contract", default: false
  ...
  create_table "referrals", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "sign"
    t.index ["collection_id"], name: "index_referrals_on_collection_id"
    t.index ["nft_contract_id"], name: "index_referrals_on_nft_contract_id"
