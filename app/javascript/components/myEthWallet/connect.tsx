...
const Connect = (props) => {
  ...
  const connect = async () => {
    const connect = new MEWconnect.Provider({
  ...
  return (
    <React.Fragment>
      {address && <a onClick={webDisconnect}>Disconnect</a>}
      ...
      {!address && (
        <React.Fragment>
          <div className="box-item-wallet">
            ...
            <span className="content-connect-wallet" onClick={webConnect}>
              MEWconnect DAPP
            </span>
          </div>
          <div className="box-item-wallet">
            ...
            <span className="content-connect-wallet" onClick={connect}>
              MyEther Wallet
            </span>
          </div>
        </React.Fragment>
