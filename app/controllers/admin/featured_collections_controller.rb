class Admin::FeaturedCollectionsController < Admin::BaseController
  ...
  def is_maxed_out
    ...
    if @featured_collections.count >= 10
      redirect_to admin_featured_collections_url, alert: "Already created 10 featured collections. Please destroy some to create new"
    end
  end
end
